...
<s:if test="isWidgetVisible('cpHomeGestore','ptNuovoOperatoreForestaleGestore')" >
...
<s:text name="cpHomeGestore.ptNuovoOperatoreForestaleGestore.statictext.label" />
...
<s:if test="isWidgetVisible('cpHomeGestore','ptRicercaOperatoreForestaleGestore')" >
...
<s:text name="cpHomeGestore.ptRicercaOperatoreForestaleGestore.statictext.label" />
