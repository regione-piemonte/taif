...
<fmt:setBundle basename="/it/csi/taif/topforweb/presentation/topforweb/action/gestore/CpInserimentoOperatoreAction" />
	...
	<div id="p_fpWizardRiconoscimenti" class="formPanelBlock"><!-- startFragment:p_fpWizardRiconoscimenti -->
		
	
<div class="formPanel" id="fpWizardRiconoscimenti">
...
<customtag:widgetsPanelColumn   labelField="true" textLabel="%{getText('cpInserimentoOperatore.cbInserimentoAgenziaFormativaRiconoscimento.label')}" labelFor="widg_cbInserimentoAgenziaFormativaRiconoscimento" errorFor="appDataidAgenziaFormativaSelezionata" labelId="cbInserimentoAgenziaFormativaRiconoscimentoLbl"
	position="first"  >
...
/>
<s:select name="appDataidAgenziaFormativaSelezionata" id="widg_cbInserimentoAgenziaFormativaRiconoscimento"
...
<customtag:widgetsPanelColumn   labelField="true" textLabel="%{getText('cpInserimentoOperatore.cbInserimentoUnitaFormativaRiconoscimento.label')}" labelFor="widg_cbInserimentoUnitaFormativaRiconoscimento" errorFor="appDataidUnitaFormativaSelezionata" labelId="cbInserimentoUnitaFormativaRiconoscimentoLbl"
	position="first"  >
...
<s:url id="widg_cbInserimentoUnitaFormativaRiconoscimentourlComboBoxValueChange"
   ...
   includeParams="all" portletUrlType="action" 
/>
<s:select name="appDataidUnitaFormativaSelezionata" id="widg_cbInserimentoUnitaFormativaRiconoscimento"
...
<customtag:widgetsPanelColumn   labelField="true" textLabel="%{getText('cpInserimentoOperatore.calDataRiconoscimento.label')}" labelFor="widg_calDataRiconoscimento" errorFor="widg_calDataRiconoscimento" labelId="calDataRiconoscimentoLbl"
	  >
...
<s:textfield 
	...
	name="widg_calDataRiconoscimento" id="widg_calDataRiconoscimento"
...
<s:if test="isWidgetVisible('cpInserimentoOperatore','wpRiconoscimenti_3_1_fictitious_')" >

	
<customtag:widgetsPanelColumn  colSpan="2" position="first" >


<!-- widget wpRiconoscimenti_3_1_fictitious_ -->
...
decorator="it.csi.taif.topforweb.presentation.decorator.gestore.CpInserimentoOperatoreTblInserimentoRiconoscimentiCustomDecorator"               class="dataTable">
 ...
 >
		...
		<display:column property="iconaAttestato" titleKey="cpInserimentoOperatore.tblInserimentoRiconoscimenti.iconaAttestato.label" 
			sortable="false" headerClass="nosort"
			    media="html"
 ...
 >
	...
	<!-- endFragment:p_fpWizardRiconoscimenti --></div>
