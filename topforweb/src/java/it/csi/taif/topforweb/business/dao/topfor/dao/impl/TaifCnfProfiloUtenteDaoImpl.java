...
/*PROTECTED REGION ID(R1835768417) ENABLED START*/
...
public class TaifCnfProfiloUtenteDaoImpl extends AbstractDAO implements TaifCnfProfiloUtenteDao {
	...
	public List<TaifCnfProfiloUtenteByProfiloUtenteDto> findByProfiloUtente(
		...
		sql.append(
				"SELECT cnfProfiloUtente.ID_PROFILO_UTENTE as idProfilo, cnfProfiloUtente.PROFILO_UTENTE as profiloUtente, cnfProfiloUtente.FK_PROCEDURA as idProcedura");
