 ...
 * @generated
 */
public class TaifTPersonaCorsiExtMetadata extends DAOMetadata {
	 ...
	 * DAO: [taifTPersonaCorsiExt]
	 * tabella: [TAIF_T_PERSONA].
	 */
	public TaifTPersonaCorsiExtMetadata() {
		...
		propertyNames = new String[]{"idPersona", "fkTitoloStudio", "fkTitoloStudioFra", "fkNazione", "codiceFiscale",
				...
				"mail", "altriStudi", "dataInserimento", "dataAggiornamento", "fkConfigUtente"};
	...
	/**
	 * Method 'getTableName'
	 * Restituisce il nome della tabella a cui il DAO [taifTPersonaCorsiExt] fa riferimento
	 * (TAIF_T_PERSONA).
	 * @return String
	 * @generated
	 */
