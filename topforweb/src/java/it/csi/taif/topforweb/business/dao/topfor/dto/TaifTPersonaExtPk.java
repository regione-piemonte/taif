...
/**
 * Primary Key del DTO TaifTPersonaExtDto.
 * E' utilizzato per tutte le operazioni di lettura dati per chiave primaria. 
 * @generated
 */
public class TaifTPersonaExtPk implements Serializable {
	...
	/**
	 * Method 'equals'. 
	 * Due istanze di TaifTPersonaExtPk sono equals se i valori di tutti i campi coincidono.
	 * 
	 * @param _other
	...
	public boolean equals(Object _other) {
		...
		if (!(_other instanceof TaifTPersonaExtPk)) {
			return false;
		}

		final TaifTPersonaExtPk _cast = (TaifTPersonaExtPk) _other;
	...
	public String toString() {
		...
		ret.append("it.csi.taif.topforweb.business.dao.topfor.dto.TaifTPersonaExtPk: ");
