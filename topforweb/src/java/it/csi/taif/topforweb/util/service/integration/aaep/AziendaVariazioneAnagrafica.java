...
public class AziendaVariazioneAnagrafica  implements java.io.Serializable {
    ...
    private it.csi.taif.topforweb.util.service.integration.aaep.VariazioneAnagrafica[] listaVariazAnagrafica;
    ...
    public AziendaVariazioneAnagrafica(
           ...
           it.csi.taif.topforweb.util.service.integration.aaep.VariazioneAnagrafica[] listaVariazAnagrafica) {
           this.codici = codici;
     ...
     */
    public it.csi.taif.topforweb.util.service.integration.aaep.VariazioneAnagrafica[] getListaVariazAnagrafica() {
        return listaVariazAnagrafica;
    }
     ...
     */
    public void setListaVariazAnagrafica(it.csi.taif.topforweb.util.service.integration.aaep.VariazioneAnagrafica[] listaVariazAnagrafica) {
        this.listaVariazAnagrafica = listaVariazAnagrafica;
    }
