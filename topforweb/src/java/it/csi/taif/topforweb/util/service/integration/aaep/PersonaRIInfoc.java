...
public class PersonaRIInfoc  implements java.io.Serializable {
    ...
    private it.csi.taif.topforweb.util.service.integration.aaep.CaricaPersonaInfoc[] listaCaricaPersInfoc;

    private it.csi.taif.topforweb.util.service.integration.aaep.FallimentoPersonaInfoc[] listaFallPersInfoc;
    ...
    public PersonaRIInfoc(
           ...
           it.csi.taif.topforweb.util.service.integration.aaep.CaricaPersonaInfoc[] listaCaricaPersInfoc,
           it.csi.taif.topforweb.util.service.integration.aaep.FallimentoPersonaInfoc[] listaFallPersInfoc,
     ...
     */
    public it.csi.taif.topforweb.util.service.integration.aaep.CaricaPersonaInfoc[] getListaCaricaPersInfoc() {
        return listaCaricaPersInfoc;
    }
     ...
     */
    public void setListaCaricaPersInfoc(it.csi.taif.topforweb.util.service.integration.aaep.CaricaPersonaInfoc[] listaCaricaPersInfoc) {
        this.listaCaricaPersInfoc = listaCaricaPersInfoc;
    }
     ...
     */
    public it.csi.taif.topforweb.util.service.integration.aaep.FallimentoPersonaInfoc[] getListaFallPersInfoc() {
        return listaFallPersInfoc;
    }
     ...
     */
    public void setListaFallPersInfoc(it.csi.taif.topforweb.util.service.integration.aaep.FallimentoPersonaInfoc[] listaFallPersInfoc) {
        this.listaFallPersInfoc = listaFallPersInfoc;
    }
