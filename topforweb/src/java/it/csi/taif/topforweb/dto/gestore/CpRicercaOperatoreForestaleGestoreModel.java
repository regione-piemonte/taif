 ...
 * logica di business associata alla Schermata [cpRicercaOperatoreForestaleGestore]
 */
@Validation
public class CpRicercaOperatoreForestaleGestoreModel extends BaseSessionAwareDTO {
	...
	/**
	 * imposta il valore dell' ApplicationData 'appDataelencoProvinceRicercaOperatoreGestore'
	 * @param value
	 * @generated
	 */

	public void setAppDataelencoProvinceRicercaOperatoreGestore(
			java.util.ArrayList<it.csi.taif.topforweb.dto.common.CodeDescription> value) {
		getSession().put("appDataelencoProvinceRicercaOperatoreGestore", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDataelencoProvinceRicercaOperatoreGestore'
	 * @generated
	 */
	public java.util.ArrayList<it.csi.taif.topforweb.dto.common.CodeDescription> getAppDataelencoProvinceRicercaOperatoreGestore() {
		return (java.util.ArrayList<it.csi.taif.topforweb.dto.common.CodeDescription>) (getSession()
				.get("appDataelencoProvinceRicercaOperatoreGestore"));
	}

	/**
	 * imposta il valore dell' ApplicationData 'appDataelencoAmbitoFormativoRicercaOperatore'
	 * @param value
	 * @generated
	 */

	public void setAppDataelencoAmbitoFormativoRicercaOperatore(
			java.util.ArrayList<it.csi.taif.topforweb.dto.common.CodeDescription> value) {
		getSession().put("appDataelencoAmbitoFormativoRicercaOperatore", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDataelencoAmbitoFormativoRicercaOperatore'
	 * @generated
	 */
	public java.util.ArrayList<it.csi.taif.topforweb.dto.common.CodeDescription> getAppDataelencoAmbitoFormativoRicercaOperatore() {
		return (java.util.ArrayList<it.csi.taif.topforweb.dto.common.CodeDescription>) (getSession()
				.get("appDataelencoAmbitoFormativoRicercaOperatore"));
	}

	/**
	 * imposta il valore dell' ApplicationData 'appDataidAmbitoFormativoSelezionato'
	 * @param value
	 * @generated
	 */

	public void setAppDataidAmbitoFormativoSelezionato(java.lang.String value) {
		getSession().put("appDataidAmbitoFormativoSelezionato", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDataidAmbitoFormativoSelezionato'
	 * @generated
	 */
	public java.lang.String getAppDataidAmbitoFormativoSelezionato() {
		return (java.lang.String) (getSession().get("appDataidAmbitoFormativoSelezionato"));
	}

	/**
	 * imposta il valore dell' ApplicationData 'appDataidProvinciaSelezionatoRicercaOperatoreGestore'
	 * @param value
	 * @generated
	 */

	public void setAppDataidProvinciaSelezionatoRicercaOperatoreGestore(java.lang.String value) {
		getSession().put("appDataidProvinciaSelezionatoRicercaOperatoreGestore", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDataidProvinciaSelezionatoRicercaOperatoreGestore'
	 * @generated
	 */
	public java.lang.String getAppDataidProvinciaSelezionatoRicercaOperatoreGestore() {
		return (java.lang.String) (getSession().get("appDataidProvinciaSelezionatoRicercaOperatoreGestore"));
	}
