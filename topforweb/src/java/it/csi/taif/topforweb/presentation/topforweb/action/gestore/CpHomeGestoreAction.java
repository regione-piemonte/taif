...
import it.csi.taif.topforweb.dto.gestore.CpHomeGestoreModel;
...
import it.csi.taif.topforweb.presentation.topforweb.action.gestore.states.CpHomeGestoreScreenStates;
...
/**
 * CpHomeGestoreAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpHomeGestoreAction extends AbstractCPAction<CpHomeGestoreModel>
		implements
			Preparable,
			ModelDriven<CpHomeGestoreModel> {
	 ...
	 * strato di business.
	 */
	private CpHomeGestoreModel model;
	 ...
	 * strato di business.
	 */
	public CpHomeGestoreModel getModel() {
		return model;
	}
	...
	public void setModel(CpHomeGestoreModel modello) {
		this.model = modello;
	}
	 ...
	 */
	private static final String CP_NAME = "cpHomeGestore";
	...
	public Class modelClass() {
		return it.csi.taif.topforweb.dto.gestore.CpHomeGestoreModel.class;
	}
	...
	public void validate() {
		/*PROTECTED REGION ID(R-899737112) ENABLED START*/
