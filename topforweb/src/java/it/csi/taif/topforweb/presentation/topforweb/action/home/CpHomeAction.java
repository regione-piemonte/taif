 ...
 ******************************************************************************/
package it.csi.taif.topforweb.presentation.topforweb.action.home;
...
import it.csi.taif.topforweb.presentation.topforweb.action.home.states.CpHomeScreenStates;
...
public class CpHomeAction extends AbstractCPAction<CpHomeModel> implements Preparable, ModelDriven<CpHomeModel> {
	...
	public Class modelClass() {
		return it.csi.taif.topforweb.dto.home.CpHomeModel.class;
	}
	...
	/**
	 * Gestione dell'evento CLICKED sul widget [ptNuovoOperatoreForestaleGestore]
	 */
	@MethodProtection(level = "REJECT_SAME")
	public String handlePtNuovoOperatoreForestaleGestore_CLICKED() throws CommandExecutionException {

		return handleEventInternal("home", "cphome", "ptNuovoOperatoreForestaleGestore", "CLICKED");
