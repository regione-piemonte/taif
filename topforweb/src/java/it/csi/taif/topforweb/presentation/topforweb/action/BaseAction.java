...
public abstract class BaseAction<T extends BaseSessionAwareDTO> extends ActionSupport
	...
	private it.csi.taif.topforweb.business.BackEndFacade backEnd = null;

	public void setSpringBackEnd(it.csi.taif.topforweb.business.BackEndFacade be) {
		backEnd = be;
	}

	public it.csi.taif.topforweb.business.BackEndFacade getSpringBackEnd() {
		return backEnd;
	}

	private it.csi.taif.topforweb.business.SecurityHelper securityHelper = null;

	public void setSpringSecurityHelper(it.csi.taif.topforweb.business.SecurityHelper sh) {
		securityHelper = sh;
	}

	public it.csi.taif.topforweb.business.SecurityHelper getSpringSecurityHelper() {
