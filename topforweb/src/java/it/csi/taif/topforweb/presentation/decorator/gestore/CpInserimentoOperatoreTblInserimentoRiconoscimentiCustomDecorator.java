...
/*PROTECTED REGION ID(R-1315995268) ENABLED START*/
...
public class CpInserimentoOperatoreTblInserimentoRiconoscimentiCustomDecorator extends TableDecorator {

	public CpInserimentoOperatoreTblInserimentoRiconoscimentiCustomDecorator() {
		super();

	}

	/*PROTECTED REGION ID(R-278671047) ENABLED START*/
	...
	public Object getIconaCancella() {
		...
		if (ConvertUtil.checkIsNullOrEmpty(curr.getIconaCancella())) {
			html.append(
					"<a href=\"/topforweb/base/gestore/cpInserimentoOperatore!handleTblInserimentoRiconoscimenti_CLICKED.do?idRiga=");
			html.append(curr.getIdRiconoscimento());
			html.append("&idColonna=");
			html.append(Constants.ICONA_CANCELLA);
			html.append("\"");
			html.append("\" class=\"elimina\" title=\" cancella riconoscimento con id = ");
			html.append(curr.getIdRiconoscimento());
			html.append("\">");
			html.append("X</a>");
		}
