...
/*PROTECTED REGION ID(R1429837830) ENABLED START*/
...
public class CpDomandaTblAttrezzatureCascoForestaleCustomDecorator extends TableDecorator {

	public CpDomandaTblAttrezzatureCascoForestaleCustomDecorator() {
		super();

	}

	/*PROTECTED REGION ID(R-1495924157) ENABLED START*/
	...
	public Object getIconaCancella() {
		...
		html.append("<a href=\"/taifweb/base/domanda/CpDomanda!handleTblAttrezzatureCascoForestale_CLICKED.do?idRiga=");
