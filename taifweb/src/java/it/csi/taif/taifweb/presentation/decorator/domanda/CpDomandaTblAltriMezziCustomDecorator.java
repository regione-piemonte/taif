...
/*PROTECTED REGION ID(R267671410) ENABLED START*/
...
public class CpDomandaTblAltriMezziCustomDecorator extends TableDecorator {

	public CpDomandaTblAltriMezziCustomDecorator() {
		super();

	}

	/*PROTECTED REGION ID(R835824815) ENABLED START*/
	...
	public Object getIconaCancella() {
		...
		html.append("<a href=\"/taifweb/base/domanda/CpDomanda!handleTblAltriMezzi_CLICKED.do?idRiga=");
