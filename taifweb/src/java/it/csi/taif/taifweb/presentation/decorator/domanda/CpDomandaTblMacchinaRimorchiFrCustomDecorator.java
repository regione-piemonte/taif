...
/*PROTECTED REGION ID(R-1122307772) ENABLED START*/
...
public class CpDomandaTblMacchinaRimorchiFrCustomDecorator extends TableDecorator {

	public CpDomandaTblMacchinaRimorchiFrCustomDecorator() {
		super();

	}

	/*PROTECTED REGION ID(R-1793551615) ENABLED START*/
	...
	public Object getIconaCancella() {
		...
		html.append("<a href=\"/taifweb/base/domanda/CpDomanda!handleTblMacchinaRimorchiFr_CLICKED.do?idRiga=");
