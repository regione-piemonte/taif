...
/*PROTECTED REGION ID(R1352745986) ENABLED START*/
...
public class CpDomandaTblMacchineMovimentoATerraCustomDecorator extends TableDecorator {

	public CpDomandaTblMacchineMovimentoATerraCustomDecorator() {
		super();

	}

	/*PROTECTED REGION ID(R1055948095) ENABLED START*/
	...
	public Object getIconaCancella() {
		...
		html.append("<a href=\"/taifweb/base/domanda/CpDomanda!handleTblMacchineMovimentoATerra_CLICKED.do?idRiga=");
