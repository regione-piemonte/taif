...
/*PROTECTED REGION ID(R1072038049) ENABLED START*/
...
public class CpDomandaTblMacchineCippatriciCustomDecorator extends TableDecorator {

	public CpDomandaTblMacchineCippatriciCustomDecorator() {
		super();

	}

	/*PROTECTED REGION ID(R1462359454) ENABLED START*/
	...
	public Object getIconaCancella() {
		...
		html.append("<a href=\"/taifweb/base/domanda/CpDomanda!handleTblMacchineCippatrici_CLICKED.do?idRiga=");
