...
/*PROTECTED REGION ID(R1516423886) ENABLED START*/
...
public class CpDomandaTblMacchinaVerricelliCustomDecorator extends TableDecorator {

	public CpDomandaTblMacchinaVerricelliCustomDecorator() {
		super();

	}

	/*PROTECTED REGION ID(R-2000861429) ENABLED START*/
	...
	public Object getIconaCancella() {
		...
		html.append("<a href=\"/taifweb/base/domanda/CpDomanda!handleTblMacchinaVerricelli_CLICKED.do?idRiga=");
