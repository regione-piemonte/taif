...
/*PROTECTED REGION ID(R2095615166) ENABLED START*/
...
public class CpDomandaTbAttivitaLegnameCustomDecorator extends TableDecorator {

	public CpDomandaTbAttivitaLegnameCustomDecorator() {
		super();

	}

	/*PROTECTED REGION ID(R-257243909) ENABLED START*/
	...
	public Object getIconaCancella() {
		...
		html.append("<a href=\"/taifweb/base/domanda/CpDomanda!handleTbAttivitaLegname_CLICKED.do?idRiga=");
