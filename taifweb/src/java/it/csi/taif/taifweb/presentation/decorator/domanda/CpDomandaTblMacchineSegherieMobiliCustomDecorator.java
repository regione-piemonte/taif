...
/*PROTECTED REGION ID(R2139878677) ENABLED START*/
...
public class CpDomandaTblMacchineSegherieMobiliCustomDecorator extends TableDecorator {

	public CpDomandaTblMacchineSegherieMobiliCustomDecorator() {
		super();

	}

	/*PROTECTED REGION ID(R82466578) ENABLED START*/
	...
	public Object getIconaCancella() {
		...
		html.append("<a href=\"/taifweb/base/domanda/CpDomanda!handleTblMacchineSegherieMobili_CLICKED.do?idRiga=");
