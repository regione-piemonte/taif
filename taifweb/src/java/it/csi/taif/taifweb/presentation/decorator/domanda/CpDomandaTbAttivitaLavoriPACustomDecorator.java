...
/*PROTECTED REGION ID(R-1103194857) ENABLED START*/
...
public class CpDomandaTbAttivitaLavoriPACustomDecorator extends TableDecorator {

	public CpDomandaTbAttivitaLavoriPACustomDecorator() {
		super();

	}

	/*PROTECTED REGION ID(R677973908) ENABLED START*/
	...
	public Object getIconaCancella() {
		LavoroPA curr = (LavoroPA) getCurrentRowObject();
		StringBuffer html = new StringBuffer();
		html.append("<a href=\"/taifweb/base/domanda/CpDomanda!handleTbAttivitaLavoriPA_CLICKED.do?idRiga=");
