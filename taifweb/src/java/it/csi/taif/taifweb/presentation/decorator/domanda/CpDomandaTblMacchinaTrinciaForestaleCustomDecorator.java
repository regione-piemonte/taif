...
/*PROTECTED REGION ID(R607610358) ENABLED START*/
...
public class CpDomandaTblMacchinaTrinciaForestaleCustomDecorator extends TableDecorator {

	public CpDomandaTblMacchinaTrinciaForestaleCustomDecorator() {
		super();

	}

	/*PROTECTED REGION ID(R1372490803) ENABLED START*/
	...
	public Object getIconaCancella() {
		...
		html.append("<a href=\"/taifweb/base/domanda/CpDomanda!handleTblMacchinaTrinciaForestale_CLICKED.do?idRiga=");
