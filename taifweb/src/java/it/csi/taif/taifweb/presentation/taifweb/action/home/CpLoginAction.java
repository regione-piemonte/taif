...
import it.csi.taif.taifweb.dto.home.CpLoginModel;
...
import it.csi.taif.taifweb.presentation.taifweb.action.home.states.CpLoginScreenStates;
...
@Validation()
@Conversion()
public class CpLoginAction extends AbstractCPAction<CpLoginModel> implements Preparable, ModelDriven<CpLoginModel> {
	...
	public Class modelClass() {
		return it.csi.taif.taifweb.dto.home.CpLoginModel.class;
	}
	...
	/**
	 * Gestione dell'evento CLICKED sul widget [btnSubmitLogin]
	 */
	@MethodProtection(level = "REJECT_SAME")
	public String handleBtnSubmitLogin_CLICKED() throws CommandExecutionException {

		return handleEventInternal("home", "cplogin", "btnSubmitLogin", "CLICKED");
