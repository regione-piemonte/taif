...
/*PROTECTED REGION ID(R1777994544) ENABLED START*/
...
public class CpDomandaTblMacchinaRimorchiCustomDecorator extends TableDecorator {

	public CpDomandaTblMacchinaRimorchiCustomDecorator() {
		super();

	}

	/*PROTECTED REGION ID(R1284323309) ENABLED START*/
	...
	public Object getIconaCancella() {
		...
		html.append("<a href=\"/taifweb/base/domanda/CpDomanda!handleTblMacchinaRimorchi_CLICKED.do?idRiga=");
