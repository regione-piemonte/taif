...
/*PROTECTED REGION ID(R-1083155347) ENABLED START*/
...
public class CpDomandaTblMacchinaSemiCustomDecorator extends TableDecorator {

	public CpDomandaTblMacchinaSemiCustomDecorator() {
		super();

	}

	/*PROTECTED REGION ID(R753972330) ENABLED START*/
	...
	public Object getIconaCancella() {
		...
		html.append("<a href=\"/taifweb/base/domanda/CpDomanda!handleTblMacchinaSemi_CLICKED.do?idRiga=");
