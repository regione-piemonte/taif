...
/*PROTECTED REGION ID(R1324553) ENABLED START*/
...
public class CpDomandaTblMacchineGruACavoCustomDecorator extends TableDecorator {

	public CpDomandaTblMacchineGruACavoCustomDecorator() {
		super();

	}

	/*PROTECTED REGION ID(R1219904774) ENABLED START*/
	...
	public Object getIconaCancella() {
		...
		html.append("<a href=\"/taifweb/base/domanda/CpDomanda!handleTblMacchineGruACavo_CLICKED.do?idRiga=");
