...
/*PROTECTED REGION ID(R-1764278890) ENABLED START*/
...
public class CpDomandaTblMacchineMovimentoATerraFrCustomDecorator extends TableDecorator {

	public CpDomandaTblMacchineMovimentoATerraFrCustomDecorator() {
		super();

	}

	/*PROTECTED REGION ID(R2076167123) ENABLED START*/
	...
	public Object getIconaCancella() {
		...
		html.append("<a href=\"/taifweb/base/domanda/CpDomanda!handleTblMacchineMovimentoATerraFr_CLICKED.do?idRiga=");
