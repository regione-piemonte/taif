...
/*PROTECTED REGION ID(R-430348064) ENABLED START*/
...
public class CpDomandaTblAttrezzaturePantaloniAntitaglioCustomDecorator extends TableDecorator {

	public CpDomandaTblAttrezzaturePantaloniAntitaglioCustomDecorator() {
		super();

	}

	/*PROTECTED REGION ID(R-1685569123) ENABLED START*/
	...
	public Object getIconaCancella() {
		...
		html.append(
				"<a href=\"/taifweb/base/domanda/CpDomanda!handleTblAttrezzaturePantaloniAntitaglio_CLICKED.do?idRiga=");
