...
/*PROTECTED REGION ID(R-691363813) ENABLED START*/
...
public class CpDomandaTblMezziDiTrasportoCustomDecorator extends TableDecorator {

	public CpDomandaTblMezziDiTrasportoCustomDecorator() {
		super();

	}

	/*PROTECTED REGION ID(R-1413215336) ENABLED START*/
	...
	public Object getIconaCancella() {
		...
		html.append("<a href=\"/taifweb/base/domanda/CpDomanda!handleTblMezziDiTrasporto_CLICKED.do?idRiga=");
