...
import it.csi.taif.taifweb.dto.common.CpErrorModel;
...
import it.csi.taif.taifweb.presentation.taifweb.action.common.states.CpErrorScreenStates;
...
/**
 * CpErrorAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpErrorAction extends AbstractCPAction<CpErrorModel> implements Preparable, ModelDriven<CpErrorModel> {
	...
	public void setModel(CpErrorModel modello) {
		this.model = modello;
	}
	 ...
	 */
	private static final String CP_NAME = "cpError";
	...
	public Class modelClass() {
		return it.csi.taif.taifweb.dto.common.CpErrorModel.class;
	}
	...
	public void validate() {
		/*PROTECTED REGION ID(R1310290436) ENABLED START*/
