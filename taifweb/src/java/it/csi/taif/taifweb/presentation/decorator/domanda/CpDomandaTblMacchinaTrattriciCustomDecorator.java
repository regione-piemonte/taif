...
/*PROTECTED REGION ID(R-489104311) ENABLED START*/
...
public class CpDomandaTblMacchinaTrattriciCustomDecorator extends TableDecorator {

	public CpDomandaTblMacchinaTrattriciCustomDecorator() {
		super();

	}

	/*PROTECTED REGION ID(R1424980806) ENABLED START*/
	...
	public Object getIconaCancella() {
		...
		html.append("<a href=\"/taifweb/base/domanda/CpDomanda!handleTblMacchinaTrattrici_CLICKED.do?idRiga=");
