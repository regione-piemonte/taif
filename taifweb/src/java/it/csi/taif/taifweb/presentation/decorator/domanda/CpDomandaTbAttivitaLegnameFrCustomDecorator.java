...
/*PROTECTED REGION ID(R-831568046) ENABLED START*/
...
public class CpDomandaTbAttivitaLegnameFrCustomDecorator extends TableDecorator {

	public CpDomandaTbAttivitaLegnameFrCustomDecorator() {
		super();

	}

	/*PROTECTED REGION ID(R-1475930993) ENABLED START*/
	...
	public Object getIconaCancella() {
		LegnameAssortimentoTrattato curr = (LegnameAssortimentoTrattato) getCurrentRowObject();
		StringBuffer html = new StringBuffer();
		html.append("<a href=\"/taifweb/base/domanda/CpDomanda!handleTbAttivitaLegnameFr_CLICKED.do?idRiga=");
