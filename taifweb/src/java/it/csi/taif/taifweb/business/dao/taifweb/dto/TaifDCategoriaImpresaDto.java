...
/**
 * Data transfer object relativo al DAO TaifDCategoriaImpresaDao.
 * @generated
 */
public class TaifDCategoriaImpresaDto extends TaifDCategoriaImpresaPk {

	private static final long serialVersionUID = 1L;

	/**
	 * store della proprieta' associata alla colonna CATEGORIA_IMPRESA
	 * @generated
	 */
	protected String categoriaImpresa;

	/**
	 * Imposta il valore della proprieta' categoriaImpresa associata alla
	 * colonna CATEGORIA_IMPRESA.
	 * @generated
	 */
	public void setCategoriaImpresa(String val) {

		categoriaImpresa = val;

	}

	/**
	 * Legge il valore della proprieta' categoriaImpresa associata alla
	 * @generated
	 */
	public String getCategoriaImpresa() {
	...
	/**
	 * Crea una istanza di TaifDCategoriaImpresaPk a partire dal valore dei campi chiave del DTO
	 * 
	 * @return TaifDCategoriaImpresaPk
	 * @generated
	 */
	public TaifDCategoriaImpresaPk createPk() {
		return new TaifDCategoriaImpresaPk(idCategoria);
	}
