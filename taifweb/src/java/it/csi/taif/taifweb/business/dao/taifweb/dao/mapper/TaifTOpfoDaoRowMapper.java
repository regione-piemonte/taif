...
public class TaifTOpfoDaoRowMapper extends BaseDaoRowMapper implements org.springframework.jdbc.core.RowMapper {
	...
	public Object mapRow(ResultSet rs, int row) throws SQLException {
		...
		if (dtoInstance instanceof TaifTOpfoBySoggettoGestoreDto) {
			return mapRow_internal((TaifTOpfoBySoggettoGestoreDto) dtoInstance, rs, row);
		}
	...
	/**
	 * Metodo specifico di mapping relativo al DTO custom TaifTOpfoBySoggettoGestoreDto.
	 * 
	 * @param rs
	 * @param row
	 * @throws SQLException
	 * @return TaifTOpfoBySoggettoGestoreDto
	 * @generated
	 */

	public TaifTOpfoBySoggettoGestoreDto mapRow_internal(TaifTOpfoBySoggettoGestoreDto objectToFill, ResultSet rs,
			int row) throws SQLException {
		TaifTOpfoBySoggettoGestoreDto dto = objectToFill;

		if (mapAllColumns || columnsToReadMap.get("IDPERSONA") != null)
			dto.setIdPersona((Integer) rs.getObject("idPersona"));

		if (mapAllColumns || columnsToReadMap.get("STATOOPFO") != null)
			dto.setStatoOpfo((Integer) rs.getObject("statoOpfo"));
