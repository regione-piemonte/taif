...
public class AttestazioneConfermaLiguria {
    ...
    private  void addTitleBodyPage(Document document, TaifTPersonaDto personaTitolareRapp,TaifTAziendaDto taifTAziendaDto, TaifTPraticaDto praticaIscritta, String tipoFirma, String filePath) throws DocumentException, IOException {
        ...
        String inscritta ="iscritta all'Albo delle imprese forestali della Liguria N."; 
        ...
        String core7= "L'amministrazione informa ai sensi dell' art. 13 del D.lgs. 30 giugno 2003 n. 196 “Codice in materia di trattamento dei dati personali” che i dati conferiti con la presente istanza saranno utilizzati in relazione allo sviluppo del procedimento amministrativo per cui essi sono specificati, nonché per gli adempimenti amministrativi ad essi conseguenti.";
        String forSpace="   ";
        String twoSpace="  ";
        String tenSpace="          ";
        Paragraph p;
       ...
       testoq.setAlignment(Element.ALIGN_LEFT);
        ...
        if(praticaIscritta.getFlgSezione()!=null) {
			if (praticaIscritta.getFlgSezione().equalsIgnoreCase(Constants.bChar)) {
				...
				richiesta3B.add(new Chunk(sezioneB, docFonts.normalFont));
			} else {
