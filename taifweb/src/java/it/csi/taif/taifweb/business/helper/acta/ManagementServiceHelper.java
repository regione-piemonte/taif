...
public class ManagementServiceHelper extends AbstractServiceHelper {

	private ManagementServicePort service;
	...
	public ManagementServiceHelper(String urlService) {

		this.urlService = urlService;

	}

	private ManagementServicePort getService()
			throws DbManagerException, ServiceException, IOException, ClassNotFoundException {
		LOGGER.debug("[ManagementServiceHelper::getService] BEGIN");

		// if (this.service == null) {
		ManagementServiceLocator serviceLoc = new ManagementServiceLocator();

		ManagementServicePort port = serviceLoc.getManagementServicePort();
		...
		this.service = (ManagementServicePort) gwfb.create();

		LOGGER.debug("[ManagementServiceHelper::getService] Service 'ManagementServicePort' INITIALIZED");
		// }

		LOGGER.debug("[ManagementServiceHelper::getService] END");
