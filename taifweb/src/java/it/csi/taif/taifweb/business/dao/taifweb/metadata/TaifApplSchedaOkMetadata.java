 ...
 * @generated
 */
public class TaifApplSchedaOkMetadata extends DAOMetadata {
	 ...
	 * DAO: [taifApplSchedaOk]
	 * tabella: [TAIF_APPL_SCHEDA_OK].
	 */
	public TaifApplSchedaOkMetadata() {
	...
	/**
	 * Method 'getTableName'
	 * Restituisce il nome della tabella a cui il DAO [taifApplSchedaOk] fa riferimento
	 * (TAIF_APPL_SCHEDA_OK).
	 * @return String
	 * @generated
	 */
