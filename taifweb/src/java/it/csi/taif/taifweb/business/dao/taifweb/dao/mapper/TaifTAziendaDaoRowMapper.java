 ...
 * @generated
 */
public class TaifTAziendaDaoRowMapper extends BaseDaoRowMapper implements org.springframework.jdbc.core.RowMapper {

	/**
	 * Dao associato al RowMapper. Serve per i supplier DAO
	 * @generated
	 */
	TaifTAziendaDaoImpl dao;
	 ...
	 */
	public TaifTAziendaDaoRowMapper(String[] columnsToRead, Class dtoClass, TaifTAziendaDao dao) {
		super(columnsToRead, dtoClass);
		this.dao = (TaifTAziendaDaoImpl) dao;
	}
	...
	public Object mapRow(ResultSet rs, int row) throws SQLException {
		...
		if (dtoInstance instanceof TaifTAziendaElencoDomandaByLegaleRappDto) {
			return mapRow_internal((TaifTAziendaElencoDomandaByLegaleRappDto) dtoInstance, rs, row);
		}
		...
		if (dtoInstance instanceof TaifTAziendaDettaglioAziendaByIdAziendaDto) {
			return mapRow_internal((TaifTAziendaDettaglioAziendaByIdAziendaDto) dtoInstance, rs, row);
		}
		if (dtoInstance instanceof TaifTAziendaElencoDomandaByLegaleRappAndProfDto) {
			return mapRow_internal((TaifTAziendaElencoDomandaByLegaleRappAndProfDto) dtoInstance, rs, row);
		}
	...
	public TaifTAziendaRicercaAziendaAvanzataDto mapRow_internal(TaifTAziendaRicercaAziendaAvanzataDto objectToFill,
		...
		if (mapAllColumns || columnsToReadMap.get("NOMETITOLARE") != null)
			dto.setNomeTitolare(rs.getString("nomeTitolare"));

		if (mapAllColumns || columnsToReadMap.get("COGNOMETITOLARE") != null)
			dto.setCognomeTitolare(rs.getString("cognomeTitolare"));
		...
		if (mapAllColumns || columnsToReadMap.get("DSSTATOPRATICAITA") != null)
			dto.setDsStatoPraticaIta(rs.getString("dsStatoPraticaIta"));

		if (mapAllColumns || columnsToReadMap.get("DSSTATOPRATICAFRA") != null)
			dto.setDsStatoPraticaFra(rs.getString("dsStatoPraticaFra"));

		if (mapAllColumns || columnsToReadMap.get("DSALBOAPPARTENENZA") != null)
			dto.setDsAlboAppartenenza(rs.getString("dsAlboAppartenenza"));

		if (mapAllColumns || columnsToReadMap.get("NSIRET") != null)
			dto.setNSiret(rs.getString("nSiret"));

		if (mapAllColumns || columnsToReadMap.get("NTVA") != null)
			dto.setNTva(rs.getString("nTva"));

		if (mapAllColumns || columnsToReadMap.get("COMUNESEDEESTERO") != null)
			dto.setComuneSedeEstero(rs.getString("comuneSedeEstero"));
	...
	/**
	 * Metodo specifico di mapping relativo al DTO custom TaifTAziendaElencoDomandaByLegaleRappDto.
	 * 
	 * @param rs
	 * @param row
	 * @throws SQLException
	 * @return TaifTAziendaElencoDomandaByLegaleRappDto
	 * @generated
	 */

	public TaifTAziendaElencoDomandaByLegaleRappDto mapRow_internal(
			TaifTAziendaElencoDomandaByLegaleRappDto objectToFill, ResultSet rs, int row) throws SQLException {
		TaifTAziendaElencoDomandaByLegaleRappDto dto = objectToFill;
		...
		if (mapAllColumns || columnsToReadMap.get("CODICEALBO") != null)
			dto.setCodiceAlbo(rs.getString("codiceAlbo"));
	...
	/**
	 * Metodo specifico di mapping relativo al DTO custom TaifTAziendaIntestazioneRiepilogoByPraticaDto.
	 * 
	 * @param rs
	 * @param row
	 * @throws SQLException
	 * @return TaifTAziendaIntestazioneRiepilogoByPraticaDto
	 * @generated
	 */
	...
	/**
	 * Metodo specifico di mapping relativo al DTO custom TaifTAziendaDettaglioAziendaByIdAziendaDto.
	 * 
	 * @param rs
	 * @param row
	 * @throws SQLException
	 * @return TaifTAziendaDettaglioAziendaByIdAziendaDto
	 * @generated
	 */

	public TaifTAziendaDettaglioAziendaByIdAziendaDto mapRow_internal(
			TaifTAziendaDettaglioAziendaByIdAziendaDto objectToFill, ResultSet rs, int row) throws SQLException {
		TaifTAziendaDettaglioAziendaByIdAziendaDto dto = objectToFill;
		...
		if (mapAllColumns || columnsToReadMap.get("FORMAGIURIDICAITA") != null)
			dto.setFormagiuridicaita(rs.getString("formagiuridicaita"));

		if (mapAllColumns || columnsToReadMap.get("FORMAGIURIDICAFRA") != null)
			dto.setFormagiuridicafra(rs.getString("formagiuridicafra"));
		...
		if (mapAllColumns || columnsToReadMap.get("NBRESALARIESFRA") != null)
			dto.setNbreSalariesFra((Integer) rs.getObject("nbreSalariesFra"));

		if (mapAllColumns || columnsToReadMap.get("TEMPSPLEINFRA") != null)
			dto.setTempsPleinFra(rs.getBigDecimal("tempsPleinFra"));
	...
	/**
	 * Metodo specifico di mapping relativo al DTO custom TaifTAziendaElencoDomandaByLegaleRappAndProfDto.
	 * 
	 * @param rs
	 * @param row
	 * @throws SQLException
	 * @return TaifTAziendaElencoDomandaByLegaleRappAndProfDto
	 * @generated
	 */

	public TaifTAziendaElencoDomandaByLegaleRappAndProfDto mapRow_internal(
			TaifTAziendaElencoDomandaByLegaleRappAndProfDto objectToFill, ResultSet rs, int row) throws SQLException {
		TaifTAziendaElencoDomandaByLegaleRappAndProfDto dto = objectToFill;
		...
		if (mapAllColumns || columnsToReadMap.get("STATOPRATICAFRANCIA") != null)
			dto.setStatoPraticaFrancia(rs.getString("statoPraticaFrancia"));
		...
		if (mapAllColumns || columnsToReadMap.get("CODICEFISCALEPERSONA2") != null)
			dto.setCodiceFiscalePersona2(rs.getString("codiceFiscalePersona2"));
