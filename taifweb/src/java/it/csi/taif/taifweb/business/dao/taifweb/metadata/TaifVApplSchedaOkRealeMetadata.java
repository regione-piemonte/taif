 ...
 * @generated
 */
public class TaifVApplSchedaOkRealeMetadata extends DAOMetadata {
	 ...
	 * DAO: [taifVApplSchedaOkReale]
	 * tabella: [TAIF_V_APPL_SCHEDA_OK_REALE].
	 */
	public TaifVApplSchedaOkRealeMetadata() {
	...
	/**
	 * Method 'getTableName'
	 * Restituisce il nome della tabella a cui il DAO [taifVApplSchedaOkReale] fa riferimento
	 * (TAIF_V_APPL_SCHEDA_OK_REALE).
	 * @return String
	 * @generated
	 */
