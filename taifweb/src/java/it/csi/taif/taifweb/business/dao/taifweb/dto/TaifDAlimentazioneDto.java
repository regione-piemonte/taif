...
/**
 * Data transfer object relativo al DAO TaifDAlimentazioneDao.
 * @generated
 */
public class TaifDAlimentazioneDto extends TaifDAlimentazionePk {
	...
	/**
	 * Crea una istanza di TaifDAlimentazionePk a partire dal valore dei campi chiave del DTO
	 * 
	 * @return TaifDAlimentazionePk
	 * @generated
	 */
	public TaifDAlimentazionePk createPk() {
		return new TaifDAlimentazionePk(idAlimentazione);
	}
