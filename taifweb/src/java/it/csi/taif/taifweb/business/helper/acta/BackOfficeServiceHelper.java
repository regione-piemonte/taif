...
import it.csi.taif.taifweb.util.service.integration.acta.backofficeservice.BackOfficeServiceLocator;
import it.csi.taif.taifweb.util.service.integration.acta.backofficeservice.BackOfficeServicePort;
...
public class BackOfficeServiceHelper extends AbstractServiceHelper{
	
	private BackOfficeServicePort service;
	...
	public BackOfficeServiceHelper(String urlService) {

		this.urlService = urlService;

	}

	private BackOfficeServicePort getService()
			throws DbManagerException, ServiceException, IOException, ClassNotFoundException {
		LOGGER.debug("[BackOfficeServiceHelper::getService] BEGIN");

		//if (this.service == null) {
			BackOfficeServiceLocator serviceLoc = new BackOfficeServiceLocator();

			BackOfficeServicePort port = serviceLoc.getBackOfficeServicePort();
...
//			
			...
			this.service = (BackOfficeServicePort) gwfb.create();

			LOGGER.debug("[BackOfficeServiceHelper::getService] Service 'BackOfficeServicePort' INITIALIZED");
		//}

		LOGGER.debug("[BackOfficeServiceHelper::getService] END");
