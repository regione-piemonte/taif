...
/**
 * Data transfer object relativo al DAO TaifRAziendaFrTipoMansDao.
 * @generated
 */
public class TaifRAziendaFrTipoMansDto extends TaifRAziendaFrTipoMansPk {

	private static final long serialVersionUID = 1L;

	/**
	 * store della proprieta' associata alla colonna NR_ADDETTI
	 * @generated
	 */
	protected Integer nrAddetti;

	/**
	 * Imposta il valore della proprieta' nrAddetti associata alla
	 * colonna NR_ADDETTI.
	 * @generated
	 */
	public void setNrAddetti(Integer val) {
	...
	/**
	 * Legge il valore della proprieta' nrAddetti associata alla
	 * @generated
	 */
	public Integer getNrAddetti() {
	...
	/**
	 * Crea una istanza di TaifRAziendaFrTipoMansPk a partire dal valore dei campi chiave del DTO
	 * 
	 * @return TaifRAziendaFrTipoMansPk
	 * @generated
	 */
	public TaifRAziendaFrTipoMansPk createPk() {
		return new TaifRAziendaFrTipoMansPk(idAzienda, idTipoMansione);
	}
