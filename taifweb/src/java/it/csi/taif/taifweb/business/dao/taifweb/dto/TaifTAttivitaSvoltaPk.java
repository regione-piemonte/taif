...
/**
 * Primary Key del DTO TaifTAttivitaSvoltaDto.
 * E' utilizzato per tutte le operazioni di lettura dati per chiave primaria. 
 * @generated
 */
public class TaifTAttivitaSvoltaPk implements Serializable {
	...
	/**
	 * Method 'equals'. 
	 * Due istanze di TaifTAttivitaSvoltaPk sono equals se i valori di tutti i campi coincidono.
	 * 
	 * @param _other
	...
	public boolean equals(Object _other) {
		...
		if (!(_other instanceof TaifTAttivitaSvoltaPk)) {
			return false;
		}

		final TaifTAttivitaSvoltaPk _cast = (TaifTAttivitaSvoltaPk) _other;
	...
	public String toString() {
		...
		ret.append("it.csi.taif.taifweb.business.dao.taifweb.dto.TaifTAttivitaSvoltaPk: ");
