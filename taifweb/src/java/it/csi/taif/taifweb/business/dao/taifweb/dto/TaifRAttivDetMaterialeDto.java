...
/**
 * Data transfer object relativo al DAO TaifRAttivDetMaterialeDao.
 * @generated
 */
public class TaifRAttivDetMaterialeDto extends TaifRAttivDetMaterialePk {

	private static final long serialVersionUID = 1L;

	/**
	 * store della proprieta' associata alla colonna DESCR_ALTRO_MATERIALE
	 * @generated
	 */
	protected String descrAltroMateriale;

	/**
	 * Imposta il valore della proprieta' descrAltroMateriale associata alla
	 * colonna DESCR_ALTRO_MATERIALE.
	 * @generated
	 */
	public void setDescrAltroMateriale(String val) {

		descrAltroMateriale = val;

	}

	/**
	 * Legge il valore della proprieta' descrAltroMateriale associata alla
	 * @generated
	 */
	public String getDescrAltroMateriale() {
	...
	/**
	 * Crea una istanza di TaifRAttivDetMaterialePk a partire dal valore dei campi chiave del DTO
	 * 
	 * @return TaifRAttivDetMaterialePk
	 * @generated
	 */
	public TaifRAttivDetMaterialePk createPk() {
		return new TaifRAttivDetMaterialePk(idMateriale, idAttivita, progressivo);
	}
