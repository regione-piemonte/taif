...
public class TaifCnfConfigUtenteDaoRowMapper extends BaseDaoRowMapper
	...
	public TaifCnfConfigUtenteProfiloByCodiceFiscaleDto mapRow_internal(
		...
		if (mapAllColumns || columnsToReadMap.get("ID_PROFILO_UTENTE") != null)
			dto.setPuIdProfiloUtente((Integer) rs.getObject("ID_PROFILO_UTENTE"));

		if (mapAllColumns || columnsToReadMap.get("PROFILO_UTENTE") != null)
			dto.setPuProfiloUtente(rs.getString("PROFILO_UTENTE"));

		if (mapAllColumns || columnsToReadMap.get("FK_SOGGETTO_GESTORE") != null)
			dto.setCuFkSoggettoGestore((Integer) rs.getObject("FK_SOGGETTO_GESTORE"));

		if (mapAllColumns || columnsToReadMap.get("ID_CONFIG_UTENTE") != null)
			dto.setCuIdConfigUtente((Integer) rs.getObject("ID_CONFIG_UTENTE"));
