...
import it.csi.taif.taifweb.util.service.integration.acta.archive.FascicoloTemporaneoPropertiesType;
...
import it.csi.taif.taifweb.util.service.integration.acta.common.ComplexPropertyType;
...
import it.csi.taif.taifweb.util.service.integration.acta.common.IdProvvedimentoAutorizzatType;
...
import it.csi.taif.taifweb.util.service.integration.acta.common.PropertyType;
import it.csi.taif.taifweb.util.service.integration.acta.common.ProtocolloPropertiesType;
import it.csi.taif.taifweb.util.service.integration.acta.common.QueryNameType;
import it.doqui.acta.actasrv.dto.acaris.type.archive.SerieTipologicaDocumentiPropertiesType;


public class DocumentServiceBindingStub extends org.apache.axis.client.Stub implements DocumentServicePort {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "tipoOperazione"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "enumTipoOperazione"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "datiCreazione"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "InfoRichiestaCreazione"), InfoRichiestaCreazione.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "IdentificatoreDocumento"));
        oper.setReturnClass(IdentificatoreDocumento.class);
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("getRappresentazioneDocumento");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "repositoryId"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "ObjectIdType"), ObjectIdType.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "principalId"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "PrincipalIdType"), PrincipalIdType.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "puntoDiPartenza"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "IdentificatoreDocumento"), IdentificatoreDocumento.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "recuperaAscendenza"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "boolean"), boolean.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "MappaIdentificazioneDocumento"));
        oper.setReturnClass(MappaIdentificazioneDocumento.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "info"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        oper.addFault(new org.apache.axis.description.FaultDesc(
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("trasformaDocumentoPlaceholderInDocumentoElettronico");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "repositoryId"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "ObjectIdType"), ObjectIdType.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "principalId"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "PrincipalIdType"), PrincipalIdType.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "classificazioneId"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "ObjectIdType"), ObjectIdType.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "registrazioneId"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "ObjectIdType"), ObjectIdType.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "infoRichiesta"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "InfoRichiestaTrasformazione"), InfoRichiestaTrasformazione.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "documentoFisico"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "DocumentoFisicoIRC"), DocumentoFisicoIRC[].class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "IdentificazioneTrasformazione"));
        oper.setReturnClass(IdentificazioneTrasformazione[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "trasformazione"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "acarisFault"),
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "principalId"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "PrincipalIdType"), PrincipalIdType.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "identifiers"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "ObjectIdType"), ObjectIdType[].class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "filter"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "PropertyFilterType"), PropertyFilterType.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "ObjectResponseType"));
        oper.setReturnClass(ObjectResponseType[].class);
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("creaDocumentoFisicoInDocumentRoot");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "repositoryId"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "ObjectIdType"), ObjectIdType.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "typeId"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("archive.acaris.acta.doqui.it", "enumDocumentObjectType"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "associativeObjectTypeId"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("archive.acaris.acta.doqui.it", "enumFolderObjectType"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "principalId"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "PrincipalIdType"), PrincipalIdType.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "properties"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "PropertiesType"), PropertiesType.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "associativeObjectProperties"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "PropertiesType"), PropertiesType.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "folderId"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "ObjectIdType"), ObjectIdType.class, false, false);
        param.setOmittable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "contentStream"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "acarisContentStreamType"), AcarisContentStreamType.class, false, false);
        param.setOmittable(true);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "ObjectIdType"));
        oper.setReturnClass(ObjectIdType.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "objectId"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "acarisFault"),
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("uploadContenutoFisico");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "repositoryId"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "ObjectIdType"), ObjectIdType.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "principalId"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "PrincipalIdType"), PrincipalIdType.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "contFisico"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "acarisContentStreamType"), AcarisContentStreamType.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "ObjectIdType"));
        oper.setReturnClass(ObjectIdType.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "objectId"));
    ...
    private void addBindings2() {
            ...
            cachedSerQNames.add(qName);
            cls = AcarisContentStreamType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = IdMovimentazioneType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = IdProvvedimentoAutorizzatType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "CollocazioneDocumento");
            cachedSerQNames.add(qName);
            cls = CollocazioneDocumento.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "ContenutoFisicoIdMap");
            cachedSerQNames.add(qName);
            cls = ContenutoFisicoIdMap.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "ContenutoFisicoIRC");
            cachedSerQNames.add(qName);
            cls = ContenutoFisicoIRC.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "DocumentoArchivisticoIdMap");
            cachedSerQNames.add(qName);
            cls = DocumentoArchivisticoIdMap.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "DocumentoArchivisticoIRC");
            cachedSerQNames.add(qName);
            cls = DocumentoArchivisticoIRC.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "DocumentoFisicoIdMap");
            cachedSerQNames.add(qName);
            cls = DocumentoFisicoIdMap.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "DocumentoFisicoIRC");
            cachedSerQNames.add(qName);
            cls = DocumentoFisicoIRC.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "enumParentFolder");
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            qName = new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "enumStepErrorAction");
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            qName = new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "enumTipoDocumentoArchivistico");
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            qName = new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "enumTipoDocumentoCreazione");
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            qName = new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "enumTipoOperazione");
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            qName = new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "FailedStepsInfo");
            cachedSerQNames.add(qName);
            cls = FailedStepsInfo.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "IdentificatoreDocumento");
            cachedSerQNames.add(qName);
            cls = IdentificatoreDocumento.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "IdentificazioneTrasformazione");
            cachedSerQNames.add(qName);
            cls = IdentificazioneTrasformazione.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "InfoRichiestaCreazione");
            cachedSerQNames.add(qName);
            cls = InfoRichiestaCreazione.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "InfoRichiestaTrasformazione");
            cachedSerQNames.add(qName);
            cls = InfoRichiestaTrasformazione.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "MappaIdentificazioneDocumento");
            cachedSerQNames.add(qName);
            cls = MappaIdentificazioneDocumento.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "StepErrorAction");
            cachedSerQNames.add(qName);
            cls = StepErrorAction.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public IdentificatoreDocumento creaDocumento(ObjectIdType repositoryId, PrincipalIdType principalId, java.lang.String tipoOperazione, InfoRichiestaCreazione datiCreazione) throws java.rmi.RemoteException, AcarisFaultType {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("document.acaris.acta.doqui.it", "creaDocumento"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {repositoryId, principalId, tipoOperazione, datiCreazione});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (IdentificatoreDocumento) _resp;
            } catch (java.lang.Exception _exception) {
                return (IdentificatoreDocumento) org.apache.axis.utils.JavaUtils.convert(_resp, IdentificatoreDocumento.class);
            }
        }
  ...
  throw axisFaultException;
    ...
    public MappaIdentificazioneDocumento getRappresentazioneDocumento(ObjectIdType repositoryId, PrincipalIdType principalId, IdentificatoreDocumento puntoDiPartenza, boolean recuperaAscendenza) throws java.rmi.RemoteException, AcarisFaultType {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("document.acaris.acta.doqui.it", "getRappresentazioneDocumento"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {repositoryId, principalId, puntoDiPartenza, new java.lang.Boolean(recuperaAscendenza)});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (MappaIdentificazioneDocumento) _resp;
            } catch (java.lang.Exception _exception) {
                return (MappaIdentificazioneDocumento) org.apache.axis.utils.JavaUtils.convert(_resp, MappaIdentificazioneDocumento.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
    if (axisFaultException.detail != null) {
  ...
  throw axisFaultException;
    ...
    public IdentificazioneTrasformazione[] trasformaDocumentoPlaceholderInDocumentoElettronico(ObjectIdType repositoryId, PrincipalIdType principalId, ObjectIdType classificazioneId, ObjectIdType registrazioneId, InfoRichiestaTrasformazione infoRichiesta, DocumentoFisicoIRC[] documentoFisico) throws java.rmi.RemoteException, AcarisFaultType {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("document.acaris.acta.doqui.it", "trasformaDocumentoPlaceholderInDocumentoElettronico"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {repositoryId, principalId, classificazioneId, registrazioneId, infoRichiesta, documentoFisico});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (IdentificazioneTrasformazione[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (IdentificazioneTrasformazione[]) org.apache.axis.utils.JavaUtils.convert(_resp, IdentificazioneTrasformazione[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
    if (axisFaultException.detail != null) {
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {repositoryId, principalId, identifiers, filter});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (ObjectResponseType[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (ObjectResponseType[]) org.apache.axis.utils.JavaUtils.convert(_resp, ObjectResponseType[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
    if (axisFaultException.detail != null) {
  ...
  throw axisFaultException;
    ...
    public ObjectIdType creaDocumentoFisicoInDocumentRoot(ObjectIdType repositoryId, java.lang.String typeId, java.lang.String associativeObjectTypeId, PrincipalIdType principalId, PropertiesType properties, PropertiesType associativeObjectProperties, ObjectIdType folderId, AcarisContentStreamType contentStream) throws java.rmi.RemoteException, AcarisFaultType {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("document.acaris.acta.doqui.it", "creaDocumentoFisicoInDocumentRoot"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {repositoryId, typeId, associativeObjectTypeId, principalId, properties, associativeObjectProperties, folderId, contentStream});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (ObjectIdType) _resp;
            } catch (java.lang.Exception _exception) {
                return (ObjectIdType) org.apache.axis.utils.JavaUtils.convert(_resp, ObjectIdType.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
    if (axisFaultException.detail != null) {
  ...
  throw axisFaultException;
    ...
    public ObjectIdType uploadContenutoFisico(ObjectIdType repositoryId, PrincipalIdType principalId, AcarisContentStreamType contFisico) throws java.rmi.RemoteException, AcarisFaultType {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("document.acaris.acta.doqui.it", "uploadContenutoFisico"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {repositoryId, principalId, contFisico});
