...
public final class ConvertUtil extends GenericUtil {
   ...
   public static java.util.Date convertToDate(String s, String format) throws Exception {
	...
	public static String createStringForQueryWithParamMap(java.util.List<String> lista) {
		String stringa ="";
		for(int i=0;i<lista.size();i++) {
			stringa+= "'"+lista.get(i)+"'";
			if(i!=lista.size()-1) {
	...
	public static String getLinguaFromSoggettoGestore(int idSoggettoGestore) {
		String lingua = it.csi.taif.taifweb.business.dao.util.Constants.itaLang;
		switch (idSoggettoGestore) {
			case it.csi.taif.taifweb.business.dao.util.Constants.GESTORE_SUPERADMIN :
			case it.csi.taif.taifweb.business.dao.util.Constants.GESTORE_PIEMONTE :
			case it.csi.taif.taifweb.business.dao.util.Constants.GESTORE_LIGURIA :
			case it.csi.taif.taifweb.business.dao.util.Constants.GESTORE_VDA :
				lingua = it.csi.taif.taifweb.business.dao.util.Constants.itaLang;
				break;
			case it.csi.taif.taifweb.business.dao.util.Constants.GESTORE_ASDEFS :
			case it.csi.taif.taifweb.business.dao.util.Constants.GESTORE_SEFSAM :
				lingua = it.csi.taif.taifweb.business.dao.util.Constants.fraLang;
				break;
		}
		return lingua;
	}
	
	public static String getFlagLinguaFromSoggettoGestore(int idSoggettoGestore) {
		String lingua = it.csi.taif.taifweb.business.dao.util.Constants.itaLang;
		switch (idSoggettoGestore) {
			case it.csi.taif.taifweb.business.dao.util.Constants.GESTORE_SUPERADMIN :
			case it.csi.taif.taifweb.business.dao.util.Constants.GESTORE_PIEMONTE :
			case it.csi.taif.taifweb.business.dao.util.Constants.GESTORE_LIGURIA :
			case it.csi.taif.taifweb.business.dao.util.Constants.GESTORE_VDA :
				lingua = it.csi.taif.taifweb.business.dao.util.Constants.iLang;
				break;
			case it.csi.taif.taifweb.business.dao.util.Constants.GESTORE_ASDEFS :
			case it.csi.taif.taifweb.business.dao.util.Constants.GESTORE_SEFSAM :
				lingua = it.csi.taif.taifweb.business.dao.util.Constants.fLang;
				break;
		}
		return lingua;
	}
	
	public static String getLinguaFromTipoAccesso(int tipoAccesso) {
		String lingua = it.csi.taif.taifweb.business.dao.util.Constants.itaLang;
		switch (tipoAccesso) {
		case it.csi.taif.taifweb.business.dao.util.Constants.TIPO_ACCESSO_LIBERO_ITA :
			lingua = it.csi.taif.taifweb.business.dao.util.Constants.itaLang;
			break;
		case it.csi.taif.taifweb.business.dao.util.Constants.TIPO_ACCESSO_LIBERO_FRA :
			lingua = it.csi.taif.taifweb.business.dao.util.Constants.fraLang;
			break;
		}
		return lingua;
	...
	public static String createStringForQueryWithAttivita(List<Attivita> attivitaSvolteList) {
		String stringa ="(";
		for(int i=0;i<attivitaSvolteList.size();i++) {
			stringa+= attivitaSvolteList.get(i).getIdAttivita();
			if(i!=attivitaSvolteList.size()-1) {
				stringa+=",";
			} else {
				stringa+=")";
			}
	...
	public static String getCodeUnitaMisura(String unitaMisura) {
		String u ="";
		if(checkIsNullOrEmpty(unitaMisura)) {
			if(unitaMisura.equalsIgnoreCase(Constants.UNITA_MISURA_TONNELLATE)) {
				u = it.csi.taif.taifweb.business.dao.util.Constants.two;
			} else if(unitaMisura.equalsIgnoreCase(Constants.UNITA_MISURA_QUINTALI)) {
				u = it.csi.taif.taifweb.business.dao.util.Constants.one;
			} else if(unitaMisura.equalsIgnoreCase(Constants.UNITA_MISURA_METRI_CUBI)) {
				u = it.csi.taif.taifweb.business.dao.util.Constants.three;
			}  
		}
		return u;
	}
