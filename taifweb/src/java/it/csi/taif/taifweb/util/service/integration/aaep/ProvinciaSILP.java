...
public class ProvinciaSILP  implements java.io.Serializable {
    ...
    private it.csi.taif.taifweb.util.service.integration.aaep.ComuneSILP[] listaComuniSILP;
    ...
    public ProvinciaSILP(
           ...
           it.csi.taif.taifweb.util.service.integration.aaep.ComuneSILP[] listaComuniSILP) {
     ...
     */
    public it.csi.taif.taifweb.util.service.integration.aaep.ComuneSILP[] getListaComuniSILP() {
        return listaComuniSILP;
    }
     ...
     */
    public void setListaComuniSILP(it.csi.taif.taifweb.util.service.integration.aaep.ComuneSILP[] listaComuniSILP) {
        this.listaComuniSILP = listaComuniSILP;
    }
