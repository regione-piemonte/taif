...
public class PrimpaforservIstanzaServiceLocator extends org.apache.axis.client.Service implements it.csi.taif.taifweb.util.service.integration.primpaforserv.PrimpaforservIstanzaService {
    ...
    public it.csi.taif.taifweb.util.service.integration.primpaforserv.PrimpaforservIstanza_PortType getprimpaforservIstanza() throws javax.xml.rpc.ServiceException {
    ...
    public it.csi.taif.taifweb.util.service.integration.primpaforserv.PrimpaforservIstanza_PortType getprimpaforservIstanza(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            it.csi.taif.taifweb.util.service.integration.primpaforserv.PrimpaforservIstanzaSoapBindingStub _stub = new it.csi.taif.taifweb.util.service.integration.primpaforserv.PrimpaforservIstanzaSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (it.csi.taif.taifweb.util.service.integration.primpaforserv.PrimpaforservIstanza_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                it.csi.taif.taifweb.util.service.integration.primpaforserv.PrimpaforservIstanzaSoapBindingStub _stub = new it.csi.taif.taifweb.util.service.integration.primpaforserv.PrimpaforservIstanzaSoapBindingStub(new java.net.URL(primpaforservIstanza_address), this);
                _stub.setPortName(getprimpaforservIstanzaWSDDServiceName());
                return _stub;
            }
        }
