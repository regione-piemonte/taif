...
public final class RegexConstants {
	 ...
	 * Espressione regolare per la partita IVA
	 */
	public static final String PECMAIL = "^(?)(\\\".+?(?<!\\\\\\\\)\\\"@)|(([0-9a-zA-Z]((\\\\.(?!\\\\.))|[-!#\\\\$%&'\\\\*\\\\+/=\\\\?\\\\^`{}|~\\\\w])*)(?<=[0-9a-zA-Z])@)(?)([(\\\\d{1,3}.){3}\\\\d{1,3}])|(([0-9a-zA-Z][-0-9a-zA-Z]*[0-9a-zA-Z]*.)+[a-zA-Z0-9][-a-zA-Z0-9]{0,22}[a-zA-Z0-9])$";
	/**
	...
	public static final String TVA_FRANCESE = "^(FR)?[0-9A-Z]{2}[0-9]{9}$";
	
	public static final String CODICE_FISCALE_PERSONA ="^[a-zA-Z]{6}[0-9]{2}[a-zA-Z][0-9]{2}[a-zA-Z][0-9]{3}[a-zA-Z]$";
	 ...
	 * Espressione regolare per la partita IVA
	 */
	public static final String N_SIRET_FRANCESE = "^[a-zA-Z_0-9]{14}$";
