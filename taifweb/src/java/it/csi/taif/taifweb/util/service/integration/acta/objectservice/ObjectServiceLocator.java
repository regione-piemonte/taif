...
public class ObjectServiceLocator extends org.apache.axis.client.Service implements ObjectService {
    ...
    public ObjectServicePort getObjectServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public ObjectServicePort getObjectServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ObjectServiceBindingStub _stub = new ObjectServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ObjectServicePort.class.isAssignableFrom(serviceEndpointInterface)) {
                ObjectServiceBindingStub _stub = new ObjectServiceBindingStub(new java.net.URL(ObjectServicePort_address), this);
                _stub.setPortName(getObjectServicePortWSDDServiceName());
                return _stub;
            }
        }
