...
public class AziendaSILP  implements java.io.Serializable {
    ...
    private it.csi.taif.taifweb.util.service.integration.aaep.ListaProspDisabSILP[] listaProspDisabSILP;
    ...
    private it.csi.taif.taifweb.util.service.integration.aaep.ListaSediSILP[] listaSediSILP;
    ...
    public AziendaSILP(
           ...
           it.csi.taif.taifweb.util.service.integration.aaep.ListaProspDisabSILP[] listaProspDisabSILP,
           ...
           it.csi.taif.taifweb.util.service.integration.aaep.ListaSediSILP[] listaSediSILP,
     ...
     */
    public it.csi.taif.taifweb.util.service.integration.aaep.ListaProspDisabSILP[] getListaProspDisabSILP() {
        return listaProspDisabSILP;
    }
     ...
     */
    public void setListaProspDisabSILP(it.csi.taif.taifweb.util.service.integration.aaep.ListaProspDisabSILP[] listaProspDisabSILP) {
        this.listaProspDisabSILP = listaProspDisabSILP;
    }
     ...
     */
    public it.csi.taif.taifweb.util.service.integration.aaep.ListaSediSILP[] getListaSediSILP() {
        return listaSediSILP;
    }
     ...
     * @param listaSediSILP
     */
    public void setListaSediSILP(it.csi.taif.taifweb.util.service.integration.aaep.ListaSediSILP[] listaSediSILP) {
        this.listaSediSILP = listaSediSILP;
    }
