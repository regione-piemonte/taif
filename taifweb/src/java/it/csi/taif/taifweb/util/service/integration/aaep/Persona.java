...
public class Persona  implements java.io.Serializable {
    ...
    private it.csi.taif.taifweb.util.service.integration.aaep.Carica[] listaCariche;
    ...
    public Persona(
           ...
           it.csi.taif.taifweb.util.service.integration.aaep.Carica[] listaCariche) {
     ...
     * @return listaCariche
     */
    public it.csi.taif.taifweb.util.service.integration.aaep.Carica[] getListaCariche() {
        return listaCariche;
    }
     ...
     * @param listaCariche
     */
    public void setListaCariche(it.csi.taif.taifweb.util.service.integration.aaep.Carica[] listaCariche) {
        this.listaCariche = listaCariche;
    }
