...
public class DocumentServiceLocator extends org.apache.axis.client.Service implements DocumentService {
    ...
    private java.lang.String DocumentServicePort_address = "http://tst-applogic.reteunitaria.piemonte.it/actasrv/documentWS";
    ...
    public DocumentServicePort getDocumentServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public DocumentServicePort getDocumentServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            DocumentServiceBindingStub _stub = new DocumentServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (DocumentServicePort.class.isAssignableFrom(serviceEndpointInterface)) {
                DocumentServiceBindingStub _stub = new DocumentServiceBindingStub(new java.net.URL(DocumentServicePort_address), this);
                _stub.setPortName(getDocumentServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "DocumentService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("documentservice.acaris.acta.doqui.it", "DocumentServicePort"));
        }
