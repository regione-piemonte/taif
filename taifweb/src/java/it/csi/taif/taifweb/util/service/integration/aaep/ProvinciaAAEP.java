...
public class ProvinciaAAEP  implements java.io.Serializable {
    ...
    private it.csi.taif.taifweb.util.service.integration.aaep.ComuneAAEP[] listaComuniAAEP;
    ...
    public ProvinciaAAEP(
           ...
           it.csi.taif.taifweb.util.service.integration.aaep.ComuneAAEP[] listaComuniAAEP) {
     ...
     */
    public it.csi.taif.taifweb.util.service.integration.aaep.ComuneAAEP[] getListaComuniAAEP() {
        return listaComuniAAEP;
    }
     ...
     */
    public void setListaComuniAAEP(it.csi.taif.taifweb.util.service.integration.aaep.ComuneAAEP[] listaComuniAAEP) {
        this.listaComuniAAEP = listaComuniAAEP;
    }
