...
public class AttivitaUltimoAnno6 extends it.csi.taif.taifweb.dto.domanda.AttivitaUltimoAnno
		implements
	...
	public String toString() {
		/*PROTECTED REGION ID(R468315744) ENABLED START*/
