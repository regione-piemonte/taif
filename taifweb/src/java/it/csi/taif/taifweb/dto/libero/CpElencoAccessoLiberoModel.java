 ...
 * logica di business associata alla Schermata [cpElencoAccessoLibero]
 */
@Validation
public class CpElencoAccessoLiberoModel extends BaseSessionAwareDTO {
	...
	// Table tblElencoAziendeAccessoLibero

	private it.csi.taif.taifweb.dto.gestore.Azienda widgTblElencoAziendeAccessoLibero;

	public void setWidg_tblElencoAziendeAccessoLibero(it.csi.taif.taifweb.dto.gestore.Azienda value) {
		widgTblElencoAziendeAccessoLibero = value;
	}

	public it.csi.taif.taifweb.dto.gestore.Azienda getWidg_tblElencoAziendeAccessoLibero() {
		return widgTblElencoAziendeAccessoLibero;
	}
	...
	public boolean validateAnswerForWidg_captchaExportRicercaLibera(String answer) {
		nl.captcha.Captcha captcha = (nl.captcha.Captcha) (this.getSession()
				.get(it.csi.taif.taifweb.util.Constants.CAPTCHA_SESSION_NAME));
		if (captcha != null) {
