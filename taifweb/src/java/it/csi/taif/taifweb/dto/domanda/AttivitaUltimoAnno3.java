...
public class AttivitaUltimoAnno3 extends it.csi.taif.taifweb.dto.domanda.AttivitaUltimoAnno
		implements
	...
	public String toString() {
		/*PROTECTED REGION ID(R1595711837) ENABLED START*/
