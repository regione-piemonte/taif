...
public class AttivitaUltimoAnno8 extends it.csi.taif.taifweb.dto.domanda.AttivitaUltimoAnno
		implements
	...
	public String toString() {
		/*PROTECTED REGION ID(R1148374114) ENABLED START*/
