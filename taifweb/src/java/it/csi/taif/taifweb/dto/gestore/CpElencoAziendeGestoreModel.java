 ...
 * logica di business associata alla Schermata [cpElencoAziendeGestore]
 */
@Validation
public class CpElencoAziendeGestoreModel extends BaseSessionAwareDTO {
	...
	// Table tblElencoAziendeGestore

	private it.csi.taif.taifweb.dto.gestore.Azienda widgTblElencoAziendeGestore;

	public void setWidg_tblElencoAziendeGestore(it.csi.taif.taifweb.dto.gestore.Azienda value) {
		widgTblElencoAziendeGestore = value;
	}

	public it.csi.taif.taifweb.dto.gestore.Azienda getWidg_tblElencoAziendeGestore() {
		return widgTblElencoAziendeGestore;
	}
