...
public class AttivitaUltimoAnno7 extends it.csi.taif.taifweb.dto.domanda.AttivitaUltimoAnno
		implements
	...
	public String toString() {
		/*PROTECTED REGION ID(R-1339138719) ENABLED START*/
